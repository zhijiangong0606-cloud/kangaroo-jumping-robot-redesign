...
class OpenTrue3DFixedAssembly
{
    [STAThread]
    static void Main()
    {
        string asmPath = @"C:\Users\Gzj\Desktop\kangaroo_robot_redesign\solidworks_basic_model\KangarooRobot_TRUE_3D_FIXED_assembly.SLDASM";
        ...
        if (model == null)
        {
            Console.WriteLine("Failed to open. errors=" + errors + " warnings=" + warnings);
        ...
        Console.WriteLine("Opened fixed true 3D assembly: " + asmPath);
    }
}
